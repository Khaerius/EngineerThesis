...
training_data = load_data("Badania/Obrazy/resized_styles/")
...
history = model.fit(Xrgb, yrgb, batch_size=32, epochs=9, callbacks=[tensorboard], validation_split=0.1, shuffle=True)
